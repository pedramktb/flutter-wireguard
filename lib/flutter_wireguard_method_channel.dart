...
class FlutterWireguardMethodChannel extends FlutterWireguardPlatformInterface {
  static const _methodChannel = MethodChannel("dev.fluttercommunity.flutter_wireguard/methodChannel");
  static const _eventChannel = EventChannel('dev.fluttercommunity.flutter_wireguard/eventChannel');
  ...
  Stream<Map<String, dynamic>> statusStream() => _eventChannel.receiveBroadcastStream().map((event) => event is Map
      ? {
          "name": event["name"] is String ? event["name"] : throw invalidStatus,
          "state": event["state"] is String ? event["state"] : throw invalidStatus,
